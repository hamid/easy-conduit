...
lang: fa-IR
---
توی این مطلب سعی کردم که خیلی ساده توضیح بدم که چطور می‌تونید به هزاران **هموطن** خودتون توی ایران اینترنت آزاد بدید. اونم با هزینه خیلی کم، و خیلی ساده جوری که نیاز به دونستن هیچ چیزی نیست. تمامی مراحل هم با اسکرین شات توضیح دادم که ,اضخ و گویا باشه. 
<br/>
احتمالا اگر وارد این لینک شدی  میدونی Conduit چیه اگر نمی دونی بخش مقدمه رو بخون. توی ادامه من یک روشی رو توضیح دادم که هر کسی با حداقل اطلاعات و بدون کد و با تلفن همراهش بتونه یک سرور کوچیک conduit اونم توی حدود یک ربع بسازه و بتونه کمکی به اینترنت آزاد داخل ایران بکنه. کار اصلا سختی نیست و با یک هزینه حداقلی می‌تونید این کار رو بکنید و مطمعن باشید که وقتی این کارو بکنید و در اخر تصویر زیر رو ببیند حس خیلی خوبی از این کار خواهید داشت حس اینکه با یک اقدام خیلی ساده دسترسی هزاران نفر به اینترنت آزاد رو فراهم کردید. 
<br/>
