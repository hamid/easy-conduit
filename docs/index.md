...
اگر وارد این لینک شدی احتمالا میدونی Conduit چیه اگر نمی دونی بخش مقدمه رو بخون. توی ادامه من یک روشی رو توضیح دادم که هر کسی با حداقل اطلاعات و بدون کد و با تلفن همراهش بتونه یک سرور کوچیک conduit اونم توی ۱۵ دقیقه بسازه و در حد خودش بتونه کمکی به اینترنت آزاد داخل ایران بکنه. کار اصلا سختی نیست و با یک هزینه حداقلی می‌تونید این کار رو بکنید و مطمعن باشید که وقتی این کارو بکنید و تصویر زیر رو ببیند حس خیلی خوبی از این کار خواهید داشت حس اینکه با یک اقدام خیلی ساده دسترسی هزاران نفر به اینترنت آزاد رو فراهم می‌کنید.
<br/><br/>
